...
return (function () {
        ...
        function issueAjaxRequest(elt, verb, path, eventTarget) {
          ...
          if(elt.tagName === 'FORM') {
            // issueAjaxRequestForForm(elt, verb, path, eventTarget);
            return;
          }
        ...
        function issueAjaxRequestForForm(elt, verb, path, eventTarget) {

        let isValidToContinue = true;
        ...
        const promise = service.getFormValidationTask(service.getElementUID(elt));
