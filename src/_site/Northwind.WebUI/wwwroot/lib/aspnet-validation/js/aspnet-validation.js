    ...
    /******/
      ...
      /******/ ({
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
          ...
          __webpack_require__.d(__webpack_exports__, "MvcValidationProviders", function () {
                  ...
                  if (success) {
                    fetch(form.action, {
                      ...
                      body: new FormData(form)
                        ...
                        .then(response => {
                          const turbolinksLocation = response.headers.get('Turbolinks-Location');
                          Turbolinks.visit(turbolinksLocation);
                          return  response.text();
                        })
                        .then(result => {
                          function doThis() {
                            document.querySelector('message').innerHTML = result;
                            // document.removeEventListener('turbolinks:load', doThis);
                          }
                          
                          document.addEventListener('DOMContentLoaded', (e) => doThis());
                        })
                        .catch(error => {
